...
public class MainActivity extends AppCompatActivity {
    private static final String CATEGORY_SAMPLE = "com.android.androidosample.SAMPLE";

    @BindView(R.id.list)
    public RecyclerView mSamplesRecyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSamplesRecyclerView.setAdapter(new ResolveInfoAdapter(this, getAllSampleActivities()));
    }
